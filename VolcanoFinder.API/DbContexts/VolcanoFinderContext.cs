    ...
    public class VolcanoFinderContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Volcano>().HasData(
                new Volcano("Mount Etna", "https://upload.wikimedia.org/wikipedia/commons/8/8d/Mt_Etna_and_Catania.JPG", 4)
                {
                    Id = 1,
                ...
                new Volcano("Mount Fuji", "https://upload.wikimedia.org/wikipedia/commons/1/1b/080103_hakkai_fuji.jpg", 2)
                {
                    Id = 2,
                ...
                new Volcano("Mount Kilimanjaro", "https://upload.wikimedia.org/wikipedia/commons/6/6b/Mt._Kilimanjaro_12.2006.JPG", 1)
                {
                    Id = 3,
